...
from cloudnation.exceptions import CustomApiException
from .models import *
...
class appplansSerializer(serializers.ModelSerializer):
    class Meta:
        model = appplans
        fields = '__all__'
        
class databasedetailsSerializer(serializers.ModelSerializer): 
    class Meta:
        model = databasedetails
        fields = '__all__'

class dbplansSerializer(serializers.ModelSerializer):
    class Meta:
        model = dbplans
        fields = '__all__'

class envvariablesSerializer(serializers.ModelSerializer):
    class Meta:
        model = envvariables
        fields = '__all__'